        ...
        if ($response) {
            ...
            <div class='mt-4'>
                ...
                <div class='flex justify-between items-center'>
                    ...
                    <div
                        class='py-4 px-16 bg-yellow-400 rounded-full h-4 w-4 flex items-center justify-center text-1xl text-white mt-4 shadow-lg cursor-pointer'>
                        <?php echo htmlspecialchars($response['task_status']); ?>
                    </div>
                </div>
            </div>
            <?php
