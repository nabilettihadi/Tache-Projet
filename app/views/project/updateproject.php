...
<body class="min-h-screen bg-gradient-to-r from-blue-500 via-blue-700 to-blue-900 flex items-center justify-center">
    <div class="w-full max-w-md p-10 bg-white border-0 shadow-lg rounded-3xl">
        <h1 class="text-3xl font-bold mb-8 text-center text-gray-800">Update Project</h1>
        <form method="post" action="<?= BASE_URL ?>/project/update_project" class="space-y-6">
            <div>
                ...
                <input type="text" name="nameprojet" placeholder="Project Name"
