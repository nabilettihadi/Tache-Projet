        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white hidden" id="loginform">
            <form class="bg-white" method="post" action="<?php echo URLROOT; ?>users/login">
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    ...
                    <input class="pl-2 outline-none border-none" type="text" name="logmail" id=""
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                    ...
                    <input class="pl-2 outline-none border-none" type="password" name="logpass" id=""
                        placeholder="Password" />
                </div>
                <input type="submit"
                    class="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2 cursor-pointer"
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white" id="signform">
            <form class="bg-white" method="post" action="<?php echo URLROOT; ?>users/register">
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    ...
                    <input class="pl-2 outline-none border-none" type="text" name="fullname" id="fullname"
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                    ...
                    <input class="pl-2 outline-none border-none" type="password" name="pass" id="pass"
                        placeholder="Password" />
                </div><br>
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20"
                    ...
                    <input class="pl-2 outline-none border-none" type="password" name="" id="rpass"
